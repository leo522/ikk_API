...
namespace KMUH.iKASAWebApi.DomainModel.Entities	
{
	public partial class MEMBER
	{
		...
		private IList<EDUTEAMMEMBERRUNDOWN_TRANSLOG> _eDUTEAMMEMBERRUNDOWN_TRANSLOGs = new List<EDUTEAMMEMBERRUNDOWN_TRANSLOG>();
		public virtual IList<EDUTEAMMEMBERRUNDOWN_TRANSLOG> EDUTEAMMEMBERRUNDOWN_TRANSLOGs
		{
			get
			{
				return this._eDUTEAMMEMBERRUNDOWN_TRANSLOGs;
			}
		}
		
		private IList<EDUTEAMMEMBERRUNDOWN> _eDUTEAMMEMBERRUNDOWNs = new List<EDUTEAMMEMBERRUNDOWN>();
		public virtual IList<EDUTEAMMEMBERRUNDOWN> EDUTEAMMEMBERRUNDOWNs
		{
			get
			{
				return this._eDUTEAMMEMBERRUNDOWNs;
			}
		}
